...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Data attributes:', {
      arrivalPercentage: chartCanvas.getAttribute('data-arrival-percentage'),
      checkedOutAttendees: chartCanvas.getAttribute('data-checked-out-attendees')
    });
  
    // Try a simple chart initialization
