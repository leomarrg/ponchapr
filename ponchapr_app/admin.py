...
class AttendeeAdmin(admin.ModelAdmin):
    list_display = ('name', 'last_name', 'email', 'phone_number', 'arrived', 'created_at', 'unique_id', 'checkout_time', 'checked_out', 'code_confirmed', 'code_confirmed_at')  # Use 'created_at' instead
